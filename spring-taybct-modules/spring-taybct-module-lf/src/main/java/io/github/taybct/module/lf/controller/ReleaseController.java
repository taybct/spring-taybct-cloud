...
public class ReleaseController {
    ...
    final IReleaseService releaseService;
    final IReleasePermissionsService releasePermissionsService;
    ...
    @WebLog
    public R<IPage<? extends Release>> publishList(@RequestBody ReleaseQueryDTO dto, SqlPageParams sqlPageParams) {
        return R.data(getReleaseService().publishList(dto, sqlPageParams));
    }
    ...
    public R<List<ReleasePermissions>> getPermissions(@PathVariable Long releaseId, SqlPageParams sqlPageParams) {
        return R.data(getReleasePermissionsService().getPermissions(releaseId, null, sqlPageParams));
    }
}
